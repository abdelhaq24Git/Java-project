...
public class HomeAdmin extends javax.swing.JFrame {
    ...
    public HomeAdmin(Utilisateur utilisateur){
        Actuel=utilisateur;
        initComponents();
    ...
    private void initComponents() {
        ...
        btnAdminComptes = new javax.swing.JButton();
        btnConsulterBesoin = new javax.swing.JButton();
        ...
        jPanel3.setPreferredSize(new java.awt.Dimension(1066, 405));
        ...
        btnAdminComptes.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        btnAdminComptes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/user-management.png"))); // NOI18N
        btnAdminComptes.setText("Gestion des comptes");
        btnAdminComptes.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAdminComptesActionPerformed(evt);
            }
        });
        jPanel3.add(btnAdminComptes, new org.netbeans.lib.awtextra.AbsoluteConstraints(369, 251, -1, -1));

        btnConsulterBesoin.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        btnConsulterBesoin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/garbage-recycle.png"))); // NOI18N
        btnConsulterBesoin.setText("Consulter Besoins");
        btnConsulterBesoin.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnConsulterBesoinActionPerformed(evt);
            }
        });
        jPanel3.add(btnConsulterBesoin, new org.netbeans.lib.awtextra.AbsoluteConstraints(369, 334, 330, -1));
    ...
    private void btnConsulterBesoinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsulterBesoinActionPerformed
        // TODO add your handling code here:
        new GestionBesoins().setVisible(true);
    }//GEN-LAST:event_btnConsulterBesoinActionPerformed

    private void btnAdminComptesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdminComptesActionPerformed
        // TODO add your handling code here:
        new GestionComptes().setVisible(true);
    }//GEN-LAST:event_btnAdminComptesActionPerformed
    ...
    private javax.swing.JButton btnAdminComptes;
    private javax.swing.JButton btnConsulterBesoin;
